    ...
    public override void Execute(string defaultDescription = "")
    {
        ...
        if (MemoryWatchers.JechtShotTransition.Current > 0)
        {
            ...
            else if (MemoryWatchers.JechtShotTransition.Current == (BaseCutsceneValue + 0xFAAE) && Stage == 2)
            {
                ...
                //Position Tidus
                actorPositions = new Transition { ForceLoad = false, TargetActorIDs = new short[] { 1 }, Target_x = 1.0f, Target_y = -49.996f, Target_z = 172.000f, Target_var1 = 100 };
                actorPositions.Execute();

                //Position Yuna
                actorPositions = new Transition { ForceLoad = false, TargetActorIDs = new short[] { 2 }, Target_x = 22.700f, Target_y = -49.996f, Target_z = 104.599f, Target_var1 = 120 };
                actorPositions.Execute();
